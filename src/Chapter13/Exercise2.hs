...
animatedSnowMan :: Float -> Picture
animatedSnowMan t = Pictures
  ...
  , Translate 70 (-75) $ Rotate (330 + 10 * cos t) $ Scale 1.5 1.2 stickArm
  , Translate (-70) (-75) $ Rotate (220 + 5 * sin t) $ Scale 1.5 1.2 stickArm
  , Translate (-200) 70 message
  ]

main :: IO()
main = animate displayMode black animatedSnowMan
